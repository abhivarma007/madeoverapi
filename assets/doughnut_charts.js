...
// function for setting config options for doughnut charts (called for each chart)
/*
dataTimePeriod is:
    Today
    Past Week
    Past Month
*/
function setConfigOptionsForDoughnutCharts(dataTimePeriod,fileContent) {
    var dataTimeFrame = "";
...
// function to draw label in middle of all doughnut charts
function drawCenterLabelForDoughnutChart() {
